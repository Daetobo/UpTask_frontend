...
const Tarea = ({tarea}) => {
    ...
    const { descripcion, estado, fechaEntrega,nombre, prioridad,_id } = tarea;
  ...
  return (
    <div className="border-b p-5 flex justify-between items-center">
        ...
        <div className="flex flex-col lg:flex-row gap-2">
            ...
            {/* Ocultar botón de Editar para colaboradores */}
            {admin && (
                <button
            ...
            {/* Ocultar botón de Eliminar para colaboradores */}
            {admin && (
                <button
